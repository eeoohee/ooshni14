 ...
 * Original file: /Users/greenappletrees/Desktop/src2/speedbump_bw/src/aexp/speedbump_bw/ISamplingService.aidl
 */
package aexp.speedbump_bw;
public interface ISamplingService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements aexp.speedbump_bw.ISamplingService
{
private static final java.lang.String DESCRIPTOR = "aexp.speedbump_bw.ISamplingService";
...
/**
 * Cast an IBinder object into an aexp.speedbump_bw.ISamplingService interface,
 * generating a proxy if needed.
 */
public static aexp.speedbump_bw.ISamplingService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof aexp.speedbump_bw.ISamplingService))) {
return ((aexp.speedbump_bw.ISamplingService)iin);
}
return new aexp.speedbump_bw.ISamplingService.Stub.Proxy(obj);
}
...
case TRANSACTION_setNoiseSensitivity:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.setNoiseSensitivity(_arg0);
reply.writeNoException();
return true;
}
}
...
private static class Proxy implements aexp.speedbump_bw.ISamplingService
{
...
@Override public void setSensitivity(double sensitivity) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeDouble(sensitivity);
...
@Override public void setNoiseSensitivity(int noiseSensitivity) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(noiseSensitivity);
mRemote.transact(Stub.TRANSACTION_setNoiseSensitivity, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_setNoiseSensitivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
...
public void setSensitivity(double sensitivity) throws android.os.RemoteException;
public void setNoiseSensitivity(int noiseSensitivity) throws android.os.RemoteException;
}
